      ...
      return (
        ...
        >
          <Form layout="vertical">
            ...
            <FormItem label="最短修业年限">
              {getFieldDecorator('shortest_study_time')(
                <Input placeholder="请输入最短修业年限" />
              )}
            </FormItem>
            <FormItem label="最长修业年限">
              {getFieldDecorator('total_study_time')(
                <Input placeholder="请输入最长修业年限" />
              )}
            </FormItem>
            <FormItem label="总学分">
              {getFieldDecorator('total_study_point')(
                <Input placeholder="请输入总学分" />
              )}
            </FormItem>
            <FormItem label="选修课学分要求">
              {getFieldDecorator('selective_study_point')(
