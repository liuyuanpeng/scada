...
class GenderAgeJob extends Component {
  ...
  updateList(year) {
    year && actions.teachRestore.getDigitsList(year)
  }
...
export default smart(state => {
  return {
    data: state.teachRestore.data,
    year: state.page.year,
    coursewareMedia: state.openConfig.COURSEWARE_APPLY_RESOURCE,
